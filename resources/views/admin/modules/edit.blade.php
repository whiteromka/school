            ...
            <form action="{{ route('admin.modules.update', $module->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            ...
                            <option value="Back" {{ old('type', $module->type) == 'Back' ? 'selected' : '' }}>Back</option>
                            <option value="Front" {{ old('type', $module->type) == 'Front' ? 'selected' : '' }}>Front</option>
                            <option value="Eng" {{ old('type', $module->type) == 'Eng' ? 'selected' : '' }}>Eng</option>
                        </select>
                        @error('type')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('number') is-invalid @enderror"
                               id="number" name="number" value="{{ old('number', $module->number) }}">
                        @error('number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('level') is-invalid @enderror"
                               id="level" name="level" value="{{ old('level', $module->level) }}" min="1" required>
                        @error('level')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('module_price') is-invalid @enderror"
                               id="module_price" name="module_price" value="{{ old('module_price', $module->module_price) }}" min="0" required>
                        @error('module_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('lesson_price') is-invalid @enderror"
                               id="lesson_price" name="lesson_price" value="{{ old('lesson_price', $module->lesson_price) }}" min="0" required>
                        @error('lesson_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('count_lessons') is-invalid @enderror"
                               id="count_lessons" name="count_lessons" value="{{ old('count_lessons', $module->count_lessons) }}" min="1" required>
                        @error('count_lessons')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('duration') is-invalid @enderror"
                               id="duration" name="duration" value="{{ old('duration', $module->duration) }}" placeholder="e.g., 1 - 1.5 мес">
                        @error('duration')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('author') is-invalid @enderror" id="author" name="author" required>
                        ...
                        <option value="Roman Belov" {{ old('author', $module->author) == 'Roman Belov' ? 'selected' : '' }}>Roman Belov</option>
                        <option value="Iliah Udin" {{ old('author', $module->author) == 'Iliah Udin' ? 'selected' : '' }}>Iliah Udin</option>
                    </select>
                    @error('author')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('techs') is-invalid @enderror"
                           id="techs" name="techs" value="{{ old('techs', is_array($module->techs) ? implode(', ', $module->techs) : '') }}" placeholder="html, css, php, js">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('topics') is-invalid @enderror"
                              id="topics" name="topics" rows="5">{{ old('topics', is_array($module->topics) ? implode("\n", $module->topics) : '') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description2') is-invalid @enderror"
                              id="description2" name="description2" rows="3">{{ old('description2', $module->description2) }}</textarea>
                    @error('description2')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
