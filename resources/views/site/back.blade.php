...
@section('content')
    ...
    <div class="container">
        <div class="cy-item-tabs-wrap_ ">
            ...
            {{-- Таб контент --}}
            <div class="tab-content cy-item-tabs-content info-body-bg" style="padding: clamp(10px, 5vw, 45px); border-left: 1px solid #00eaff">
                <div class="tab-pane fade show active" id="Рынок_труда">
                        ...
                        <br>
                        <p>
                            <span class="orange">PHP</span> уровень конкуренции так же как и во всей отрасли остается высоким,
