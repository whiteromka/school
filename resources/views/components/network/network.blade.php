...
<script>
    ...
    const nodes = new vis.DataSet([
        ...
        { id: 10, label: "Bootstrap", group: "front" },
        { id: 11, label: "Pinia", group: "front" },


        // Back группа
        { id: 30, label: "PHP", group: "back" },
        { id: 31, label: "OOP", group: "back" },
        { id: 32, label: "Laravel", group: "back" },
        { id: 33, label: "Symfony", group: "back" },
        { id: 34, label: "Yii", group: "back" },
        { id: 35, label: "Composer", group: "back" },
        { id: 36, label: "API", group: "back" },
        { id: 37, label: "Request", group: "back" },
        { id: 38, label: "Services", group: "back" },
        { id: 39, label: "Auth", group: "back" },
        { id: 40, label: "Queues", group: "back" },
        { id: 41, label: "Tests", group: "back" },
        { id: 42, label: "PhpUnit", group: "back" },
        { id: 43, label: "Codeception", group: "back" },
        { id: 44, label: "Framework", group: "back" },
        { id: 45, label: "Mvc", group: "back" },
        { id: 46, label: "Components", group: "back" },
        { id: 47, label: "Architecture", group: "back" },
        { id: 48, label: "Domain", group: "back" },
        { id: 49, label: "Application", group: "back" },
        { id: 50, label: "Infrastructure", group: "back" },


        // DB группа
        { id: 100, label: "DB", group: "db" },
        { id: 101, label: "SQL", group: "db" },
        { id: 102, label: "Caches", group: "db" },
        { id: 103, label: "Brokers", group: "db" },
        { id: 104, label: "NoSql", group: "db" },
        { id: 105, label: "Elasticsearch", group: "db" },
        { id: 106, label: "MySQL", group: "db" },
        { id: 107, label: "SQLite", group: "db" },
        { id: 108, label: "PostrgeSQL", group: "db" },
        { id: 109, label: "Redis", group: "db" },
        { id: 110, label: "Memcached", group: "db" },
        { id: 111, label: "Apache Kafka", group: "db" },
        { id: 112, label: "RabbitMQ", group: "db" },

        // X группа
        { id: 150, label: "Git", group: "x" },
        { id: 151, label: "Docker Compose", group: "x" },

        // Eng group
        { id: 200, label: "English", group: "eng" },
        { id: 201, label: "Grammar", group: "eng" },
        { id: 202, label: "Times", group: "eng" },
        { id: 203, label: "Past Simple", group: "eng" },
        { id: 204, label: "Present Simple", group: "eng" },
    ]);
