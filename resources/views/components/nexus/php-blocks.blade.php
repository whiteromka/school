        ...
        <div class="row">
            <div class="col-12 px-2">
                ...
                <div class="service-card course-module mb-1"
                    ...
                    <div class="service-card-count-line-wrap" data-context="Заполненность группы в %">
                        <div class="service-card-count-line">
                            {{-- блоки .item будут добавлены через JS --}}
                        </div>
                        <span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--!Font Awesome Free v7.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M320 16a104 104 0 1 1 0 208 104 104 0 1 1 0-208zM96 88a72 72 0 1 1 0 144 72 72 0 1 1 0-144zM0 416c0-70.7 57.3-128 128-128 12.8 0 25.2 1.9 36.9 5.4-32.9 36.8-52.9 85.4-52.9 138.6l0 16c0 11.4 2.4 22.2 6.7 32L32 480c-17.7 0-32-14.3-32-32l0-32zm521.3 64c4.3-9.8 6.7-20.6 6.7-32l0-16c0-53.2-20-101.8-52.9-138.6 11.7-3.5 24.1-5.4 36.9-5.4 70.7 0 128 57.3 128 128l0 32c0 17.7-14.3 32-32 32l-86.7 0zM472 160a72 72 0 1 1 144 0 72 72 0 1 1 -144 0zM160 432c0-88.4 71.6-160 160-160s160 71.6 160 160l0 16c0 17.7-14.3 32-32 32l-256 0c-17.7 0-32-14.3-32-32l0-16z"/></svg>
                        </span>

                    </div>
{{--                    @if($module->openActiveModule)--}}
{{--                        Записалось: {{ $module->openActiveModule->users->count() }}--}}
{{--                        Макс количество: {{ $max }} тут всегда 90  --}}
{{--                    @endif--}}
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const ITEM_WIDTH = 5;      // ширина блока .item в px
            const GAP_WIDTH = 4;       // gap между блоками в px
