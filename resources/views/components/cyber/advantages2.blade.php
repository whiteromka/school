    ...
    <div class="container">
        <div class="row">
            <?php $advantages = [
                ...
                ['n' => '05', 'name' => 'Команду единомышленников', 'descr' => 'Сможете совместно вести разработку своего проекта'],
                ['n' => '06', 'name' => 'Поддержку', 'descr' => 'Вы всегда сможете к нам обратится за помощью или советом'],
            ]; ?>
